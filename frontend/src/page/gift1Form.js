            ...
            {showFirstImage ? (
                ...
                <div className="flex justify-between items-center ">
                    ...
                    <img alt="" src="/assets/Gold-Coin-left.png"
                        className="w-48 absolute top-40 left-28 transform  transition-all duration-1000 ease-in-out" />

                    <div className={`w-[200px] transition-all duration-1000 ease-in-out `}>
