  ...
  return (
    <>
      <div>
        ...
        >
          <div className="">
            <div className="p-1  bg-cover bg-center align">
              <div className="flex justify-center md:justify-center gap-5 ">
                {/* {/ 1 /} */}
                <div className="flex flex-col items-center  ">
                  <img
                    src={'/assets/hdfc/image/icon-saving&investments.png'}
                    alt=""
                    className="w-[45px] md:w-[90px] mt-2 lg:w-[120px] icon-class"
                  />
                  {/* {/ content /} */}
                  <img
                    src={'/assets/hdfc/image/savings-investments.png'}
                    alt=""
                    className="w-[80px]  md:w-[130px] lg:w-[170px] p-2 icon-btn"
                  />
                  <h1 className=" hidden text-[13px] text-[rgb(171,15,37)] font-semibold ">
                    Savings & <br />{" "}
                ...
                <div className="flex flex-col items-center ">
                  <img
                    src={'/assets/hdfc/image/icon-health.png'}
                    alt=""
                    className="w-[45px] md:w-[90px]  lg:w-[120px] mt-2 icon-class"
                  />
                  {/* {/ content /} */}
                  <img
              ...
              <div className="relative -mt-3  md:mx-32 md:mt-0 lg:mx-14  flex justify-around md:justify-around gap-28 md:gap-40 lg:gap-64">
                {/* {/ 1 /} */}
                <div className="flex flex-col items-center ml-4   relative">
                  <img
                    src={'/assets/hdfc/image/icon-pension.png'}
                    alt=""
                    className="w-[45px]  md:w-[90px]  lg:w-[120px] icon-class"
                  />
                  {/* {/ content /} */}
                  <img
                ...
                <div className="flex ">
                  <div className="flex flex-col items-center cursor-pointer" onClick={getChildPlan}>
                    <img
                      ...
                      alt=""
                      className="w-[45px]  md:w-[90px]  lg:w-[120px] animate-pulse icon-class"
                    />
                    {/* {/ content /} */}
                    <img
                  ...
                  <div className="-mr-3 md:-mr-10 lg:-mr-16  -rotate-12  lg:block ">
                    <img
                      src={'/assets/hdfc/image/arrow.png'}
                      alt=""
                      className="w-[30px] md:w-[36px]  lg:w-[65px]  mt-2 arrow animate-arrow"
                    />
                  </div>
                </div>
                {/* {/ Mobile Width /} */}
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  my-12  md:my-0 md:hidden px-2 animate fadeIn two">
                  <img
                    ...
                    alt=""
                    className="w-[90px]  lg:w-[250px] img"
                  />
                </div>
              </div>
              <div className="md:mx-24 lg:mx-5 md:m-3 lg:mt-3 md:pb-8 lg:pb:5 flex justify-between relative mar">
                {/* {/ 1 /} */}
                <div className="flex flex-col  items-center ">
                  <img
                    src={'/assets/hdfc/image/icon-protection.png'}
                    alt=""
                    className="w-[45px]  md:w-[90px]  lg:w-[120px] icon-class"
                  />
                  {/* {/ content /} */}
                ...
                <div className="md:-mt-24 lg:-mt-36  hidden md:block md:mx-3">
                  <img
                    src={'/assets/hdfc/image/insurance-policy.png'}
                    alt=""
                    className="w-[100px] md:w-[150px] lg:w-[200px] mt-3 "
                  />
                </div>
                {/* {/ 2 /} */}
                <div className="flex flex-col items-center md:-mr-2">
                  <img
                    src={'/assets/hdfc/image/icon-women.png'}
                    alt=""
                    className="w-[45px] md:w-[90px] lg:w-[110px] icon-class"
                  />
                  {/* {/ content /} */}
                  <img
